...
PlateletTurret::PlateletTurret(float x, float y) :
	Turret("play/Puffshroom_rotate.png", x, y, Price, 0.5, 10) {
...
void PlateletTurret::CreateBullet() {
    ...
    Engine::Point BulletPos = Position + normalized * 36 - normal * 6;
    getPlayScene()->EffectGroup->AddNewObject(new ShootEffect(BulletPos.x, BulletPos.y));
    // End
